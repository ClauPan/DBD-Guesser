var pos = 0;
var score = 0;
var test, question, choice, choices, chA, chB, chC, chD, submitBtn;
...
var survivor = [
    ...
    },
    {
        ...
        d: "Renato Lyra and Thalita Lyra"
    },
    {
        question: "In his backstory, Vittorio is said to have been brought by the entity from which period of time?",
        a:"Present day",
        b: "The 1900's.",
        c: "The 1300's",
        d: "The 1300's"
...
var killer = [
    ...
    },
    {
        ...
        d: "Leon S. Kennedy and Jill Valentine"
    },
    {
    ...
    },
    {
        ...
        d: "The Twins can release Victor to pounce on survivors and injure or down them."
    },
    {
    ...
    },
    {
        ...
        d: "Any survivors that come in the range of a carried survivor get afflicted by the exposed status for 30 seconds"
    },
    {
    ...
    },
    {
        ...
        d: "It made every good skill check regress the generator"
    },
    {
        ...
        d: "It allows you to kill the obsession after the gates are powered, no matter the number of hooks they have"
    },
    {
    ...
    },
    {
        ...
        d: "It makes the healing go slower and skillchecks faster while in the killer's terror radius"
    },
    {
...
function renderQuestion(){
    ...
    if(pos >= randomQuestions.length){
        ...
        input3.type = "radio";
        input3.name = "choices";
        input3.value = randomQuestions[pos].c;
        ...
        label3.innerHTML += chC;

        firstDiv.appendChild(label3);
